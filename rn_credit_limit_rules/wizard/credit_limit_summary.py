    ...
    def _onchange_partner_id(self):
        ...
        if self.account_move_id:
            if self.partner_id.credit_limit_rules_id.type == 'amount':
                ...
                receivable = amount_doc - current_document
                self.account_moves = f"{len(invoices)} Invoices - Amount Receivable {round(receivable, 2)}"
                ...
                self.amount_receivable = round(receivable, 2)
