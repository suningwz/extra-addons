...
class CreditLimitRule(models.Model):
    ...
    name = fields.Char(string="Credit Limit Rules Name",
                       required=True,
                       copy=False,
                       readonly=True,
                       index=True,
    ...
    type = fields.Selection([('amount', 'Amount'),
                             ('documents', 'Documents')], string='Credit Rule Type', default='amount')
    ...
    def create(self, vals):
        ...
        if vals.get('name', _('New')) == _('New'):
            ...
            vals['name'] = self.env['ir.sequence'].next_by_code('credit.limit.rule',
